...
<iframe src="./assets/images/Containment Index.html" width="1110" height="610" style="border: none;" scrolling="no"></iframe>

## Electricity Dataset
Actual Electricity Generation per Production Type in Europe Countries (2019~2022): This dataset contains changes in the electricity generated by different energy sources(eg. biomass, nuclear, marine.) in europe countries. The data is recorded hourly or 15-minute. Since electricity generation and consumption theoretically need to be balanced in real time, we can use generation data to approximate consumption data.

<iframe src="./assets/images/Generation Mix.html" width="1110" height="610" style="border: none;" scrolling="no"></iframe>
...
This tool is used by us to collect pageviews of terms.
